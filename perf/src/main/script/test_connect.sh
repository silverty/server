...
$JAVA -server $JAVA_OPTS $JAVA_OPTS_SCRIPT -Dlog4j.configuration="file:$LOG_FILE"  -Dwildfirechat.path="$MOQUETTE_PATH" -cp "$MOQUETTE_HOME/lib/*" io.moquette.wfchat.BenchmarkConnector
