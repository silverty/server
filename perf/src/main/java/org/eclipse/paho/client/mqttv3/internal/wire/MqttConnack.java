...
public class MqttConnack extends MqttAck {
	...
	private WFCMessage.ConnectAckPayload connectAckPayload;
    ...
    public MqttConnack(byte info, byte[] variableHeader) throws IOException {
		...
		if (variableHeader.length > 2) {
            connectAckPayload = WFCMessage.ConnectAckPayload.parseFrom(dis);
        }
		dis.close();
	}
    ...
    public WFCMessage.ConnectAckPayload getConnectAckPayload() {
        return connectAckPayload;
    }

    public void setConnectAckPayload(WFCMessage.ConnectAckPayload connectAckPayload) {
        this.connectAckPayload = connectAckPayload;
    }
}
