...
import cn.wildfirechat.bus.common.DeadMessage;
import cn.wildfirechat.bus.common.PubSubSupport;
import cn.wildfirechat.bus.config.ConfigurationError;
...
import cn.wildfirechat.subscription.Subscription;
import cn.wildfirechat.subscription.SubscriptionManager;
...
public abstract class AbstractPubSubSupport<T> implements PubSubSupport<T> {
    ...
    public AbstractPubSubSupport(IBusConfiguration configuration) {
        ...
        this.runtime = new BusRuntime(this)
                .add(IBusConfiguration.Properties.PublicationErrorHandlers, configuration.getRegisteredPublicationErrorHandlers())
                .add(IBusConfiguration.Properties.BusId, configuration.getProperty(IBusConfiguration.Properties.BusId, UUID.randomUUID().toString()));
